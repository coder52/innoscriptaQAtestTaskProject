...
public class InnoscriptaMainPage extends BasePage{
    ...
    public WebElement cookiesAblehnenButtonElement;

    @FindBy(css = "div.calendly-popup iframe")
    public WebElement appointmentFrameElement;
    ...
    public WebElement datenSendenUndHerunterladenButton;

    @FindBy(css = ".download-result__header")
    public WebElement datenSendenUndHerunterladenDownloadResultHeader;
